...
noncomputable def Tm.Ty.interpret
    ...
    {T : LambdaPCCI.Ty n} {C : CaptureSet n}
    {rho : Valuation n m} {sigma : Store m} {world : World sigma}
    (code : LambdaPCCI.Tm.Ty Gamma term T C)
  ...
  | path pathCode =>
      ...
      cases realizes with
      | loc possible =>
          simpa [Tm.rename, LambdaPCCI.Ty.rename, Shape.rename,
  ...
  | app function argument ihFunction ihArgument =>
      simpa only [Tm.rename, LambdaPCCI.Ty.rename, Shape.rename,
        ...
        TermEvidence.app (ihFunction environment)
          ...
          (Relation.refl (world := world))
  | pair =>
      simpa [Tm.rename, Def.rename, LambdaPCCI.Ty.rename, Shape.rename,

...
\Description{All six path-equality rules, all seven signature-conversion rules,
...
with the scoped codomain conversion. In the pair
...
locations and leaves this renaming implicit.
...
singleton types, abstract type members with interval signatures, explicit
subtyping transitivity, and covariance of both components of dependent pairs.

...
namespace DotToFCsub.StableSubTotality
...
structure Environment {source : DotFC.Sig}
  ...
  slots : ∀ {path : DotFC.BVar source .term}
    ...
    StableContextMetatheory.StableSlotBindings target root
...
noncomputable def ofStable {source : DotFC.Sig}
  ...
  slots := StableContextMetatheory.StableContext.slotBindings stableContext
...
private def SlotData.toBindings {source : DotFC.Sig}
    ...
    StableContextMetatheory.StableSlotBindings targetContext
      ⟨lower, upper, lookup⟩ :=
...
private def SlotData.ofBindings {source : DotFC.Sig}
    ...
    (bindings : StableContextMetatheory.StableSlotBindings targetContext root) :
  ...
  | @there _ _ _ olderType olderPath olderLookup =>
      ...
      | member rootLabel olderLower olderUpper =>
          ...
          exact SlotData.ofBindings
            (StableContextMetatheory.StableSlotBindings.weaken
...
private noncomputable def memberSlotData {source : DotFC.Sig}
  ...
  | @here _ _ =>
      ...
      · simpa [slot] using
          StableContextMetatheory.TargetContext.lookup_member_lower
            environment.target lowerType upperType
      · simpa [slot] using
          StableContextMetatheory.TargetContext.lookup_member_upper
            environment.target lowerType upperType
      · rfl
      · rfl
  | @there _ _ _ olderType olderPath olderLookup =>
      ...
      | member rootLabel olderLower olderUpper =>
          ...
          exact SlotData.ofBindings
            (StableContextMetatheory.StableSlotBindings.weaken
              ...
              (StableContextMetatheory.TargetContext.renamesMember
                environment.target lowerType upperType))
...
theorem ofStable_target {source : DotFC.Sig}
  ...
  | @snoc source context bound valid boundWf outerStable boundStable ih =>
      ...
      | top =>
          ...
          rw [targetEq]
          exact
            (StableContextMetatheory.StableContext.translate_snoc_top_target
      ...
      | bot =>
          ...
          rw [targetEq]
          exact
            (StableContextMetatheory.StableContext.translate_snoc_bot_target
              outerStable boundStable).symm
      | all domain codomain =>
          change (ofStable outerStable).environment.target.extendTerm
            boundStable.translate.target = _
          rw [ih]
          exact
            (StableContextMetatheory.StableContext.translate_snoc_all_target
              outerStable boundStable).symm
      | sel path label =>
          change (ofStable outerStable).environment.target.extendTerm
            boundStable.translate.target = _
          rw [ih]
          exact
            (StableContextMetatheory.StableContext.translate_snoc_sel_target
              outerStable boundStable).symm
      | member label lower upper =>
          ...
          rw [ih]
          exact
            (StableContextMetatheory.StableContext.translate_snoc_member_target
              outerStable boundStable).symm
...
noncomputable def id {source : DotFC.Sig}
  ...
  subst viewLower
  subst viewUpper
  let bindings := StableContextMetatheory.StableContext.slotBindings
...
structure DirectHandleResult {source : DotFC.Sig}
  ...
  bindings : StableContextMetatheory.StableSlotBindings targetContext stable.root
...
noncomputable def adjustedEvidenceTyping {source : DotFC.Sig}
    ...
    (bindings : StableContextMetatheory.StableSlotBindings targetContext
...
end DotToFCsub.StableSubTotality

import Coercions.Captures.DotToFCdot.Safety
...
theorem _root_.Captures.FCdot.Steps.trans {s1 s2 s3 : Sig} {a : FCdot.State s1}
...
theorem _root_.Captures.FCdot.Value.erase_inspects {s : Sig} :
...
theorem _root_.Captures.FCdot.Tm.inspects_reflect {s : Sig} {t : FCdot.Tm s}
...
theorem _root_.Captures.FCdot.State.inspects_reflect {s : Sig} {st : FCdot.State s}

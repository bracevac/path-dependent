import Coercions.FCsub.Context
...
/-- The acyclic member convention allocates one abstract type name. -/
abbrev names : Nat := 1

/-- The acyclic member convention carries a lower and an upper constraint. -/

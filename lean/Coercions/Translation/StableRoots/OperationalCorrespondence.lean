import Coercions.Translation.StableRoots.TermTranslation
import Coercions.Translation.Acyclic.OperationalCorrespondence
...
namespace DotToFCsub.StableRoots.TermTranslation.Compiled
...
theorem sourceStep {source : DotFC.Sig}
    ...
    {stableContext : DotToFCsub.StableRoots.StableContext valid}
    {term : DotFC.Source.Tm source} {type : DotFC.Source.Ty source}
    {typing : DotFC.Source.HasTy context term type}
    {stable : DotToFCsub.StableRoots.StableHasTy valid typing}
    (compiled : DotToFCsub.StableRoots.TermTranslation.Compiled stableContext stable)
...
end DotToFCsub.StableRoots.TermTranslation.Compiled

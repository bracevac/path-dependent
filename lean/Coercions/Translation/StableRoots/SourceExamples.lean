...
import Coercions.Translation.Acyclic.Examples

/-!
# Stable-fragment source regressions

These certificates place the existing acyclic examples inside the
...
namespace DotToFCsub.StableRoots.SourceExamples
...
the stable identity required by the stable-root layout. -/
...
end DotToFCsub.StableRoots.SourceExamples

...
/-!
# Scoped intersection-signature closure regressions
...
namespace DotToFCsub.IntersectionSignatures.ClosureExamples
...
def overlapLayout : ContextLayout.Context (Ctx.nil.snoc overlapType)
    (FCsub.PayloadScope [] 1 4) :=
  overlapBinding.layout ContextLayout.Context.nil
...
def overlapAllocated : MemberAllocated overlapLayout .here A :=
  .here ContextLayout.Context.nil overlapCollectible overlapClosed A
...
noncomputable def overlapLeftAllocatedFromOccurrence :
  ...
  newestOccurrenceAllocated ContextLayout.Context.nil overlapCollectible
...
def shadowLayout := ContextLayout.Context.signature shadowSignature overlapLayout
...
end DotToFCsub.IntersectionSignatures.ClosureExamples

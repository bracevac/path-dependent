import Coercions.DOT.Intersections
import Coercions.FCsub

/-!
# Intersection-signature encoding
...
/-- Translate the closed bounds supported by the current encoding slice. -/

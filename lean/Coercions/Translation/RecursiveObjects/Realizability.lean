import Coercions.Translation.RecursiveObjects.OperationalCorrespondence

/-!
# Realizability and preservation for the recursive-object slice

This file states the result at exactly the strength implemented by RecursiveObjects.  It
...
/-- Full recursive-object realization: source/target preservation, exact-witness

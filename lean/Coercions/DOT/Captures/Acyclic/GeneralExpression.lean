...
object-opening let boundaries.  Operational erasure and executable examples
remain separate imports so this source root has no dependency on either FC
target or on a translation.

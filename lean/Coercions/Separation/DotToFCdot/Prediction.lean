import Coercions.Separation.DotToFCdot.Safety
import Coercions.Separation.DotToFCdot.Consistency
...
theorem _root_.Separation.FCdot.Steps.trans {s1 s2 s3 : Sig} {a : FCdot.State s1}
...
theorem _root_.Separation.FCdot.Value.erase_inspects {s : Sig} :
...
has neither. -/
theorem _root_.Separation.FCdot.Tm.inspects_reflect {s : Sig} {t : FCdot.Tm s}
...
theorem _root_.Separation.FCdot.State.inspects_reflect {s : Sig} {st : FCdot.State s}

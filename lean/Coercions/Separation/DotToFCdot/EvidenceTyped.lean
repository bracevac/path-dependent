import Coercions.Separation.DotToFCdot.Evidence
import Coercions.Separation.DotToFCdot.TypesLemmas
...
theorem _root_.Separation.FCdot.Telescope.NoBnd.append {s' : Sig} {Tel₁ : FCdot.Telescope s'}
    (h₁ : Tel₁.NoBnd) :
...
theorem _root_.Separation.FCdot.Telescope.NoBnd.rename {s₁ s₂ : Sig} (ρ : FCdot.Rename s₁ s₂) :
...
theorem _root_.Separation.FCdot.Telescope.NoBnd.closedBnds {s : Sig} :
...
theorem _root_.Separation.FCdot.Telescope.ClosedBnds.append {s : Sig} {Tel₁ : FCdot.Telescope (s,x)}
    (h₁ : Tel₁.ClosedBnds) :

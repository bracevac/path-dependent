...
of arbitrary M5 `DotFCR` judgments.  Thus recursive type-member objects are
retained even though M6 adds no new recursive principle.  No reflection or
conservative-extension theorem is claimed for the larger native judgment.
-/
...
/-- Constructor-for-constructor embedding of an M5 context. -/
...
/-! ## Complete M5 derivation embedding -/
...
/-- The M5 mutually recursive object remains typable without aliases. -/

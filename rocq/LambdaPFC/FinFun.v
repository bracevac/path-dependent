...
(** Intrinsically bounded de Bruijn indices.  We keep a private-to-the-
    development representation instead of using functions over [Fin.t], so
    equality of finite maps is structural and needs no function

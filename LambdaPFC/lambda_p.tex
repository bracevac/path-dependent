...
and member selection. Store-induced signature equality
\(\tau\simeq_\sigma\tau'\) is the least sort-preserving congruence generated
...
intervening binder when necessary. Symmetry of \(\simeq_\sigma\) is
admissible because \(\equiv_\sigma\) is symmetric; transitivity is not part
of the relation and enters the proof only through coercion composition.
...
\end{minipage}
\caption{Store-indexed judgments (part 1): path and signature equality and
realization.}
\Description{All six path-equality rules, all seven signature-equality rules,
both referent rules, and all five location-realization rules.}
...
\begin{figure}[H]
\ContinuedFloat
\setlength{\afterruleskip}{0.9em plus 0.15em minus 0.1em}
\noindent
\begin{minipage}[t]{0.48\linewidth}
...
rule, all twelve semantic-coercion rules, and all five open-codomain rules.}
\end{figure}

...
theorem Tm.DeepPrecise.rename
  ...
  | tpair hy hwf =>
      intro m f Delta R' rho hmap
      simpa only [Tm.rename, Def.rename, LambdaPHistory.Ty.rename,
...
theorem Tm.DeepPrecise.weaken_runtime
    ...
    (S : LambdaPHistory.Ty n) (u : Tm n) (uv : u.IsValue) :

...
inductive Tm.Frame.DeepTy (Gamma : Ctx n) (sigma : Store n) :
    LambdaP.Original.Ty n -> Tm.Frame n ->
...
inductive Tm.Cont.DeepTy (Gamma : Ctx n) (sigma : Store n) :
    LambdaP.Original.Ty n -> Tm.Cont n ->
      LambdaP.Original.Ty n -> Prop where
| hole :
...
theorem Tm.Frame.Ty.toDeep
    {n : Nat} {Gamma : Ctx n} {S T : LambdaP.Original.Ty n}
    {F : Tm.Frame n}
...
private theorem Tm.DeepCheck.typed_inv_of_eq
    ...
    {u : Tm n} {T : LambdaP.Original.Ty n}
    (h : Tm.DeepCheck Gamma R u T) :
    forall {t : Tm n} {A : LambdaP.Original.Ty n},
      u = Tm.typed t A ->
...
theorem Tm.Frame.DeepTy.weaken_runtime
    ...
    {S T U : LambdaP.Original.Ty n} {F : Tm.Frame n}
...
theorem Tm.Cont.DeepTy.weaken_runtime
    {n : Nat} {Gamma : Ctx n} {sigma : Store n}
    {S T U : LambdaP.Original.Ty n} {k : Tm.Cont n}
...
def Tm.DeepOpening : Prop :=
  forall {n : Nat} {Gamma : Ctx n} {R : Path.ConvRel n}
      {S : LambdaP.Original.Ty n} {t : Tm (n + 1)}
      {T : LambdaP.Original.Ty (n + 1)} {x : Fin n},

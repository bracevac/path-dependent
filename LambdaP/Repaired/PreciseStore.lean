...
/-!
Syntax-directed typing for values and exact stores in the repaired calculus.
-/

namespace LambdaP.Repaired

/-- The type assigned directly by a value-introduction rule. -/
inductive Tm.PreciseTy : Ctx n -> Tm n -> LambdaP.Repaired.Ty n -> Prop where
| abs :
...
theorem Tm.PreciseTy.rename {n : Nat} {Gamma : Ctx n} {v : Tm n}
    {T : LambdaP.Repaired.Ty n} (h : Tm.PreciseTy Gamma v T) :

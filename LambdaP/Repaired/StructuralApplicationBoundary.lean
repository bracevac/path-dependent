...
theorem Tm.StructCheck.abs_inversion_of_eq
    ...
    forall {A : LambdaP.Repaired.Ty n} {body : Tm (n + 1)},
      v = Tm.abs A body ->
      exists B,
...
theorem Tm.StructCheck.app_inversion
    {n : Nat} {Gamma : Ctx n} {R : Path n -> Path n -> Prop}
    {p q : Path n} {T : LambdaP.Repaired.Ty n}
...
/-- Full packaging for a historical step whose source is an application. -/

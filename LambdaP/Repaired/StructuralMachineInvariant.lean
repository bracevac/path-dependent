...
inductive Tm.Frame.StructTy (Gamma : Ctx n) (sigma : Store n) :
    LambdaP.Repaired.Ty n -> Tm.Frame n ->
...
inductive Tm.Cont.StructTy (Gamma : Ctx n) (sigma : Store n) :
    LambdaP.Repaired.Ty n -> Tm.Cont n ->
      LambdaP.Repaired.Ty n -> Prop where
| hole :
...
theorem Tm.Frame.Ty.toStruct
    {n : Nat} {Gamma : Ctx n} {S T : LambdaP.Repaired.Ty n}
    {F : Tm.Frame n}
...
theorem Tm.StructCheck.reduce_path
    {n : Nat} {Gamma : Ctx n} {sigma : Store n}
    {p : Path n} {x : Fin n} {T : LambdaP.Repaired.Ty n}
...
private theorem Tm.StructCheck.typed_inv_of_eq
    ...
    {u : Tm n} {T : LambdaP.Repaired.Ty n}
    (h : Tm.StructCheck Gamma R u T) :
    forall {t : Tm n} {A : LambdaP.Repaired.Ty n},
      u = Tm.typed t A ->
...
theorem Tm.Frame.StructTy.weaken_runtime
    {n : Nat} {Gamma : Ctx n} {sigma : Store n}
    {S T U : LambdaP.Repaired.Ty n} {F : Tm.Frame n}
...
theorem Tm.Cont.StructTy.weaken_runtime
    {n : Nat} {Gamma : Ctx n} {sigma : Store n}
    {S T U : LambdaP.Repaired.Ty n} {k : Tm.Cont n}

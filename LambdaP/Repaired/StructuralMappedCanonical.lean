import LambdaP.Repaired.StructuralMappedRealization
import LambdaP.Repaired.StructuralPreciseCanonical
import LambdaP.Repaired.StructuralPreciseSafety

/-!
Canonical forms discharged by proof-relevant semantic maps.

The fundamental theorem in `StructuralMappedRealization` turns a structural

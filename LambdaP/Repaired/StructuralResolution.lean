...
The historical evaluator returns locations and therefore covers only paths
...
| type : LambdaP.Repaired.Ty n -> Endpoint n
...
/-! ## Agreement with the historical term-path evaluator -/

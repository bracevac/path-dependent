...
theorem Path.StructCheck.narrow
    {n : Nat} {Gamma : Ctx n} {R : Path n -> Path n -> Prop}
    {S S' : LambdaP.Repaired.Ty n} {p : Path (n + 1)}
    {d : Tau (n + 1) k}
...
theorem Tau.StructSub.narrow
    {n : Nat} {Gamma : Ctx n} {R : Path n -> Path n -> Prop}
    {S S' : LambdaP.Repaired.Ty n} {d1 d2 : Tau (n + 1) k}
...
theorem Tau.StructWf.narrow
    {n : Nat} {Gamma : Ctx n} {R : Path n -> Path n -> Prop}
    {S S' : LambdaP.Repaired.Ty n} {d : Tau (n + 1) k}
...
theorem Tm.StructCheck.narrow
    {n : Nat} {Gamma : Ctx n} {R : Path n -> Path n -> Prop}
    {S S' : LambdaP.Repaired.Ty n} {t : Tm (n + 1)}
